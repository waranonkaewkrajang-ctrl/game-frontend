...
export default function TopBar() {
  ...
  return (
    <div className="admin-topbar">
      ...
      <style>{`
        .admin-topbar { display:flex; align-items:center; justify-content:flex-end; gap:1.1rem; padding:0.6rem 1.25rem; background:white; border-bottom:1px solid #e2e8f0; flex-wrap:wrap; }
        ...
        @media (max-width:768px) {
          .admin-topbar { justify-content:space-between; gap:0.6rem; padding:0.5rem 0.75rem; }
